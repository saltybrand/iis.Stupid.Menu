    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Important Mods [7]
                ...
                new ButtonInfo { buttonText = "Force Enable Hands", method =() => Important.ForceEnableHands(), disableMethod =() => Important.ForceEnableHands(false), toolTip = "Prevents your hands from disconnecting."},
            ...
            new[] { // Movement Mods [9]
                ...
                new ButtonInfo { buttonText = "WASD Fly", aliases = new[] { "PC Fly" }, enableMethod =() => { Movement.lastPosition = GorillaTagger.Instance.rigidbody.transform.position; }, method = Movement.WASDFly, disableMethod =() => { if (GTPlayer.Instance != null && GTPlayer.Instance.GetControllerTransform(false) != null) GTPlayer.Instance.GetControllerTransform(false).parent.rotation = Quaternion.Euler(0, 0, 0); }, toolTip = "Moves your rig with <color=green>WASD</color>."},
            ...
            new[] // Detected Settings [44]
            {
                ...
                new ButtonInfo { buttonText = "Public Room Guard", enableMethod =() => PublicRoomGuard.PublicRoomGuardEnabled = true, disableMethod =() => PublicRoomGuard.PublicRoomGuardEnabled = false, toolTip = "Automatically disables all enabled detected mods when you join a public room."}
            },
