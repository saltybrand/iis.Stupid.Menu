        ...
        */
                ...
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        if (NameTagOptimize())
                        {
                            ...
                            if (cosmeticSet.items.Any(cosmetic => !cosmetic.isNullItem && !vrrig.CosmeticsString().Contains(cosmetic.itemName)))
                            {
                                if (specialMods == null)
                                    specialMods = "Cosmetx";
                                else
                ...
                try
                {
                    if ((!vrrig.isLocal || selfNameTag) && cosmetics == null)
                    {
                        ...
                        if (NameTagOptimize())
                        {
                            ...
                            foreach (var cosmetic in specialCosmetics.Where(cosmetic => vrrig.CosmeticsString().Contains(cosmetic.Key)))
                            {
                                if (cosmetics == null)
        ...
        public static void CosmeticESP()
        {
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                ...
                {
                    if (vrrig.CosmeticsString().Contains(codename))
                    {
